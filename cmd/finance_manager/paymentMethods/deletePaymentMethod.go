...
// DeletePaymentMethodCmd represents the login command
var DeletePaymentMethodCmd = &cobra.Command{
	Use:   "delete-payment-method",
...
func init() {
	DeletePaymentMethodCmd.Flags().StringVarP(&id, "id", "i", "", "Id")
}
